...
weight: 2
description: "Entendendo o funcionamento interno de modelos de linguagem"
---
...
| Conceito | Implicação |
|----------|------------|
| **Previsão probabilística** | O modelo não "pense" — prevê o mais provável |
...
- [Configurações de Saída](/fundamentos/configuracoes/) - Controle a previsão
